...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__swim

#else
#  define SWIG_init    init_swim

#endif
#define SWIG_name    "_swim"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_hi(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOO:hi",&obj0,&obj1,&obj2)) SWIG_fail;
  {
  ...
  hi(arg1,arg2,arg3,arg4,arg5,arg6);
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"hi", _wrap_hi, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
