...
if __name__ == '__main__':
    ...
    # Фильтрация зон.
    fensap_filename_phase1 = 'phase1.' + fensap_filename
    drop3d_filename_phase1 = 'phase1.' + drop3d_filename
    ...
    # Фильтрация переменных.
    fensap_filename_phase2 = 'phase2.' + fensap_filename
    drop3d_filename_phase2 = 'phase2.' + drop3d_filename
